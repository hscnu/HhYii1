...
class Sale extends BaseModel {
    ...
    public function rules() {
        return array(
            ...
            */
            ...
            array('saler_id', 'required', 'message' => '{attribute} 不能为空'),
            array('start_time', 'required', 'message' => '{attribute} 不能为空'),
            array('end_time', 'required', 'message' => '{attribute} 不能为空'),
            array('start_price', 'required', 'message' => '{attribute} 不能为空'),
            array('goods_id', 'required', 'message' => '{attribute} 不能为空'),
            array('is_admit', 'required', 'message' => '{attribute} 不能为空'),
    ...
    public function attributeLabels() {
        return array(
            ...
            */
            ...
            'saler_id'=>'卖家编号',
            'buyer_id'=>'买家编号',
            'saler_username'=>'卖家用户名',
            'buyer_username'=>'买家用户名',
            'start_time'=>'开拍时间',
            'end_time'=>'停拍时间',
            'this_record_time'=>'该价格对应时间',
            'start_price'=>'起拍价格',
            'buyer_price'=>'买家价格',
            'goods_id'=>'商品编号',
            'goods_name'=>'商品名称',
    ...
    public function getInfoFromAuction($views,$field) {
       $tmp1=Menu::model()->find("f_name='".$views."'");
       return $tmp1->{$field};
    }
