        ...
        <div class="box-detail-tab box-detail-tab mt15">
            <ul class="c">
                ...
                <li<?php if($action=='index_appoint_total'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/index_appoint_total');?>">全部列表</a>
                </li>
                <li<?php if($action=='index_appoint_wait_report'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/index_appoint_wait_report');?>">待上报<?php echo "(".$waitreportCount.")";?></a>
                </li>
                <li<?php if($action=='index_appoint_wait_verify'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/index_appoint_wait_verify');?>">待审核<?php echo "(".$waitCount.")";?></a>
                </li>
                <li<?php if($action=='index_appoint_by_pass'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/index_appoint_by_pass');?>">已通过<?php echo "(".$passCount.")";?></a>
                </li>
                <li<?php if($action=='index_appoint_by_no_pass'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/index_appoint_by_no_pass');?>">不通过<?php echo "(".$noPassCount.")";?></a>
                </li>
            </ul>
