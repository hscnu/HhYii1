        ...
        <div class="box-detail-tab box-detail-tab mt15">
            <ul class="c">
                ...
                <li<?php if($action=='indexverify_today'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_today');?>">今日已审核<?php echo "(".$todayFinishCount.")";?></a>
                </li>

                <li<?php if($action=='indexverify_wait'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_wait');?>">待审核<?php echo "(".$waitCount.")";?></a>
                </li>
