        ...
        <div class="box-detail-tab box-detail-tab mt15">
            <ul class="c">
                ...
                <li<?php if($action=='indexverify_appoint_wait'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_appoint_wait');?>">待审核</a>
                </li>
                <li<?php if($action=='indexverify_appoint_finish'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_appoint_finish');?>">已审核</a>
                </li>
                <li<?php if($action=='indexverify_appoint_by_pass'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_appoint_by_pass');?>">已通过</a>
                </li>
                <li<?php if($action=='indexverify_appoint_by_no_pass'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('YzReportHarvestInfo/indexverify_appoint_by_no_pass');?>">不通过</a>
                </li>
