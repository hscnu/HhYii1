        ...
        <div class="box-table">
            <table class="list">
                ...
                <tr>
                    ...
                    <th><?php echo $model->getAttributeLabel('res_name'); ?></th>


                    <th><?php echo $model->getAttributeLabel('user_name'); ?></th>
                    <th><?php echo $model->getAttributeLabel('comment'); ?></th>
                    <th><?php echo $model->getAttributeLabel('time_stamp'); ?></th>
                    <th><?php echo $model->getAttributeLabel('comment_star'); ?></th>
                    <th>操作</th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($arclist as $v) { ?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo $v->food_name; ?></td>
                        <td style='text-align: center;'><?php echo $v->res_name; ?></td>
                        <td><?php echo $v->user_name; ?></td>
                        <td><?php echo $v->comment; ?></td>
                        <td><?php echo date('Y-m-d H:i:s',$v->time_stamp); ?></td>
                        <td><?php echo $v->comment_star; ?></td>
                        <td>
