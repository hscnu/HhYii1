<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>养殖计划产量上报信息</h1><span class="back"><a class="btn"
                                                                                           href="javascript:;"
                                                                                           onclick="we.back();"><i
        ...
        <div class="box-table">
            <table class="list">
                ...
                foreach ($tmp as $v) {
                    ...
                    $data = YzReportPlanProduct::model()->find('report_order='.$order_id." and product_id=".$v->product_id);
                    if (empty($data)){
                        $v->production = 0;
                    }
...
<script>
    //var deleteUrl = '<?php //echo $this->createUrl('YzReportPlanProduct/delete', array('id' => 'ID')); ?>//';
