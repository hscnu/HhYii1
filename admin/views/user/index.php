        ...
        <div class="box-table">
            <table class="list">
                ...
                <tr>
                    ...
                    <th><?php echo $model->getAttributeLabel('TUNAME'); ?></th>
                    <th><?php echo $model->getAttributeLabel('TCNAME'); ?></th>
                    <th><?php echo $model->getAttributeLabel('F_ROLENAME'); ?></th>
                ...
                <?php foreach ($arclist as $v) { ?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo $v->TUNAME; ?></td>
                        <td style='text-align: center;'><?php echo $v->TCNAME; ?></td>
                        <td><?php echo $v->F_ROLENAME; ?></td>
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('update', array('id' => $v->userId)); ?>"
                               title="编辑"><i class="fa fa-edit"></i></a>
                            <a class="btn" href="javascript:;" onclick="we.dele('<?php echo $v->userId; ?>', deleteUrl);"
