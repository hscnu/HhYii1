        ...
        <div class="box-detail-tab box-detail-tab mt15">
            <ul class="c">
                ...
                <li<?php if($action=='index_appoint_wait'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('OnShelfInfo/index_appoint_wait');?>">待审核<?php echo "(".$waitCount.")";?></a>
                </li>

                <li<?php if($action=='index_appoint_finish'){?> class="current"<?php }?>>
                    <a href="<?php echo $this->createUrl('OnShelfInfo/index_appoint_finish');?>">已审核<?php echo '('.$auditedCount.')';?></a>
                </li>
        ...
        <div class="box-table">
            <table class="list">
                ...
                <tr>
                    ...
                    <th style="text-align: center" width="15%"><?php echo $model->getAttributeLabel('apply_date'); ?></th>
