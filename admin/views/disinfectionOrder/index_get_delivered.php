<div class="box">
    <div class="box-content">
        ...
        $navData[]=array('Index_deliver_finish','已配送','('.$deliverfinishCount.')');
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($model->getCHName($v->state)=='待配送'){?>
                                <button class="btn" type="button" onclick="choose_order_delivered(<?php echo $v->id;?>,'<?php echo $v->state;?>');">指派配送人</button>
                            <?php }?>
