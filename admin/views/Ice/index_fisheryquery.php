        ...
        <div class="box-header">
            ...
            <div class="box-detail-tab box-detail-tab mt15">
                <ul class="c">
                    ...
                    <li<?php if($action=='fisheryquery_submited'){?> class="current"<?php }?>>
                        <a href="<?php echo $this->createUrl('Ice/fisheryquery_submited');?>">待审核<?php echo '('.$waitCount.')'?></a>
                    </li>
                    <li<?php if($action=='fisheryquery_fishery_examined'){?> class="current"<?php }?>>
                        <a href="<?php echo $this->createUrl('Ice/fisheryquery_fishery_examined');?>">已审核<?php echo '('.$examine_finishCount.')'?></a>
                    </li>
                    <li<?php if($action=='fisheryquery_received'){?> class="current"<?php }?>>
                        <a href="<?php echo $this->createUrl('Ice/fisheryquery_received');?>">已完成<?php echo '('.$finishCount.')'?></a>
                    </li>
