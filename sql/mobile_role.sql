...
) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单及权限';

-- ----------------------------
-- Records of mobile_role
-- ----------------------------
INSERT INTO `mobile_role` VALUES ('1', 'A', 'A', '消毒', '1', '', '1', '1', '1', null);
INSERT INTO `mobile_role` VALUES ('2', 'B', 'B', '送冰', '1', '', '0', '0', '0', null);
INSERT INTO `mobile_role` VALUES ('3', 'C', 'C', '农户种植', '1', '', '0', '0', '0', null);
INSERT INTO `mobile_role` VALUES ('4', 'D', 'D', '餐饮管理', '1', '', '0', '0', '0', null);
INSERT INTO `mobile_role` VALUES ('5', 'E', 'E', '入驻管理', '1', '', '0', '0', '0', null);
INSERT INTO `mobile_role` VALUES ('6', ' ', '', '农户养殖', '1', '', '0', '0', '0', null);
INSERT INTO `mobile_role` VALUES ('7', 'F', 'F', '捕鱼模块', '1', '', '0', '0', '0', null);
